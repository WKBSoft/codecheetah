...
def openfile(request):
	...
	with open('/home/bellemanwesley/repos/'+code_loc) as f:
		data = f.read()
	return(render(request,'home.html',{'data':data,'active_page':'code','page_content':get_code_format(code_type),'default_save':code_loc}))
...
def savefile(request):
	...
	return(render(request,'home.html',{'data':my_code,'active_page':'code','page_content':get_code_format(code_type),'default_save':code_loc}))

#going to get rid of these functions and merge these
def code_page(request):
	return(render(request,'home.html',{'active_page':'code'}))
